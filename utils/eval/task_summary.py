from .eval_summary import build_ref_insight2docids, compute_single_sample_results, evaluate_insights
...
class TaskSummary(Task):
    ...
    def get_dataset_file(self) -> str:
        return os.path.join(os.path.dirname(__file__), "../../sharded_data/lost_in_conversation_summary.json")
    ...
    def evaluator_function(self, extracted_answer, sample):
        evaluator_model_card = "t-gpt-4o" if os.environ.get("USE_TRAPI", "0") == "1" else "gpt-4o-mini"
        evals = evaluate_insights(sample["insights"], extracted_answer, evaluator_model_card)
